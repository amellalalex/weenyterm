...
use weenyterm_term::config::BidiMode;
...
impl weenyterm_term::TerminalConfiguration for TermConfig {
    ...
    fn canonicalize_pasted_newlines(&self) -> weenyterm_term::config::NewlineCanon {
        match self.configuration().canonicalize_pasted_newlines {
            None => weenyterm_term::config::NewlineCanon::default(),
            Some(NewlineCanon::None) => weenyterm_term::config::NewlineCanon::None,
            Some(NewlineCanon::LineFeed) => weenyterm_term::config::NewlineCanon::LineFeed,
            Some(NewlineCanon::CarriageReturn) => {
                weenyterm_term::config::NewlineCanon::CarriageReturn
            }
            Some(NewlineCanon::CarriageReturnAndLineFeed) => {
                weenyterm_term::config::NewlineCanon::CarriageReturnAndLineFeed
            }
        }
    }

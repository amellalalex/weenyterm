        ...
        match value {
            ...
            other => {
                if let Some(value) = value.coerce_unsigned() {
                    ...
                    Err(weenyterm_dynamic::Error::NoConversion {
...
impl std::fmt::Display for FontAttributes {
    fn fmt(&self, fmt: &mut std::fmt::Formatter) -> Result<(), std::fmt::Error> {
        write!(
            fmt,
            "weenyterm.font('{}', {{weight={}, stretch='{}', style={}}})",
...
impl TextStyle {
    ...
    ///
    /// <https://github.com/wez/weenyterm/issues/456>
...
pub struct StyleRule {
    ...
    /// "Half".
    pub intensity: Option<weenyterm_term::Intensity>,
    ...
    /// "Double".
    pub underline: Option<weenyterm_term::Underline>,
    ...
    /// a value that matches this rule.
    pub blink: Option<weenyterm_term::Blink>,

...
//! The idea is to use these when weenyterm needs to request
...
pub struct TermWizTerminalPane {
    pane_id: PaneId,
    domain_id: DomainId,
    terminal: Mutex<weenyterm_term::Terminal>,
...
impl TermWizTerminalPane {
    fn new(
        ...
        let terminal = Mutex::new(weenyterm_term::Terminal::new(
            size,
...
impl Pane for TermWizTerminalPane {
    ...
    fn mouse_event(&self, event: MouseEvent) -> anyhow::Result<()> {
        ...
        use weenyterm_term::input::MouseButton;

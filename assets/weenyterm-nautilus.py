...
class OpenInWeenyTermAction(GObject.GObject, Nautilus.MenuProvider):
    def __init__(self):
        super().__init__()
    ...
    def _make_item(self, name, paths):
        item = Nautilus.MenuItem(name=name, label='Open in WeenyTerm',
            icon='org.weenyfurlong.weenyterm')
    ...
    def get_file_items(self, *args):
        ...
        if paths:
            return [self._make_item(name='WeenyTermNautilus::open_in_weenyterm', paths=paths)]
        else:
            return []
    ...
    def get_background_items(self, *args):
        ...
        if paths:
            return [self._make_item(name='WeenyTermNautilus::open_folder_in_weenyterm', paths=paths)]
        else:
            return []

...
use weenyterm_color_types::SrgbaTuple;
use weenyterm_font::{FontConfiguration, FontMetrics, GlyphInfo, RasterizedGlyph};
use weenyterm_input_types::WindowDecorations;
    ...
    fn reshape_title(&mut self) -> Option<()> {
        ...
        let infos = font
            .shape(
                ...
                None,
                weenyterm_bidi::Direction::LeftToRight,
                None,
                None,
            )
            .ok()?;

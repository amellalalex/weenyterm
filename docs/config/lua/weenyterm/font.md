...
tags:
 - font
title: weenyterm.font
---

# `weenyterm.font(family [, attributes])`
...
return {
  font = weenyterm.font 'JetBrains Mono',
}
```
...
oblique) for non-bitmap fonts, weenyterm can only select and use fonts that you
...
return {
  font = weenyterm.font('JetBrains Mono', { weight = 'Bold' }),
}
```

When resolving fonts from [font_dirs](../config/font_dirs.md), weenyterm follows CSS Fonts
...
[weenyterm.font_with_fallback](font_with_fallback.md) when you want to specify precise

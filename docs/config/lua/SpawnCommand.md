...
weenyterm.action.SpawnCommandInNewWindow {
  ...
  -- If omitted, weenyterm will infer a value based on the active pane
  ...
  -- weenyterm using `weenyterm connect` or `weenyterm serial` then the default
  ...
  -- weenyterm.mux.spawn_window, SpawnCommandInNewWindow
  position = {
    x = 10,
    y = 300,

...
In this mode, if the application hasn't enabled mouse reporting, weenyterm will
...
In versions of weenyterm prior to this configuration option being available, the

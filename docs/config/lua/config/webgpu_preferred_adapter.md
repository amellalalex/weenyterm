...
You can use the [weenyterm.gui.enumerate_gpus()](../weenyterm.gui/enumerate_gpus.md) function
...
local config = {}
local gpus = weenyterm.gui.enumerate_gpus()
...
for _, gpu in ipairs(weenyterm.gui.enumerate_gpus()) do

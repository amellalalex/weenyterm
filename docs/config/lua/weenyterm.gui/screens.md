...
* `active` - contains information about the *active* screen. The active screen is the one which has input focus. On some systems, weenyterm will return the same information as the `main` screen screen.

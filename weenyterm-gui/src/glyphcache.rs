...
use weenyterm_blob_leases::{BlobLease, BlobManager, BoxedReader};
use weenyterm_font::units::*;
use weenyterm_font::{FontConfiguration, GlyphInfo, LoadedFont, LoadedFontId};
use weenyterm_term::Underline;
...
impl GlyphCache {
    ...
    fn load_glyph(
        ...
        // can happen somehow; see <https://github.com/wez/weenyterm/issues/1042>
        ...
        match &*handle.h {
            ...
            ImageDataType::AnimRgba8 {
                ...
                if frames.len() > 1 {
                    ...
                    // frame duration that weenyterm can use when rendering.
                    ...
                    // <https://github.com/wez/weenyterm/issues/3260>

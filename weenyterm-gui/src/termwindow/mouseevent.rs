...
use weenyterm_dynamic::ToDynamic;
use weenyterm_term::input::{MouseButton, MouseEventKind as TMEK};
use weenyterm_term::{ClickPosition, LastMouseClick, StableRowIndex};
...
impl super::TermWindow {
    ...
    fn mouse_event_terminal(
        ...
        let mouse_event = weenyterm_term::MouseEvent {

fn main() {
    ...
    #[cfg(windows)]
    {
        ...
        // version number that we report in weenyterm -h.
...
BEGIN
    ...
    BEGIN
        BLOCK "040904E4"
        BEGIN
            VALUE "CompanyName",      "Weeny Furlong\0"
            VALUE "FileDescription",  "WeenyTerm - Weeny's Terminal Emulator\0"
            VALUE "FileVersion",      "{version}\0"
            VALUE "LegalCopyright",   "Weeny Furlong, MIT licensed\0"
            VALUE "InternalName",     "\0"
            VALUE "OriginalFilename", "\0"
            VALUE "ProductName",      "WeenyTerm\0"
...
"#,
    ...
    #[cfg(target_os = "macos")]
    {
        ...
        println!("cargo:rerun-if-changed=assets/macos/WeenyTerm.app/Contents/Info.plist");
